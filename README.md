...
This package provides an integration with FFmpeg for Laravel 11. [Laravel's Filesystem](http://laravel.com/docs/11.x/filesystem) handles the storage of the files.
...
* Integration with [Laravel's Filesystem](http://laravel.com/docs/11.x/filesystem), [configuration system](https://laravel.com/docs/11.x/configuration) and [logging handling](https://laravel.com/docs/11.x/errors).
* Compatible with Laravel 11, support for [Package Discovery](https://laravel.com/docs/11.x/packages#package-discovery).
