...
class MediaOpenerTest extends TestCase
{
    ...
    {
        $mediaOnNetwerk = MediaOnNetwork::make('https://openffmpeg.protone.media/1/logo.png', [
    ...
    {
        try {
            (new MediaOpener)->openUrl('https://openffmpeg.protone.media/1/video.mp4')->getDriver();
        ...
        $driver = FFMpeg::openUrl('https://openffmpeg.protone.media/1/video.mp4', [
            'Authorization' => 'Basic YWRtaW46MTIzNA==',
        ])->getDriver();
